...
const isCwdInScope = isPackageExists('@stacksjs/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@stacksjs/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@stacksjs/eslint-config'
